...
<?=strtoupper('<strong>Availability:</strong> Ships Within 5-7 Business Day')?> <br /> 
	<table><tr><td>
...
<div id="windowsize" style="display: none;">
<ol id="toc">
...
<div class="content" id="page-1">
    ...
    <table width="500px" cellpadding="2" cellspacing="2" align="center" style="vertical-align:top">
        <tr>
        	<td>
            <?php
...
<script type="text/javascript" src="js/activatables.js"> </script>
<script type="text/javascript">
