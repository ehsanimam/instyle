...
include('../functionsadmin.php');
	...
	$file_mini_thumb="../images/bridal/".$_GET["img_folder"]."/".$_GET["prod_no"]."_".$_GET["color_code"].".flv" ;
	  }else{
	$file_mini_thumb="../images/bridal/".$_GET["img_folder"]."/".$_GET["prod_no"]."_".$_GET["color_code"].".jpg" ;
	  }
	  if(@file_exists($file_mini_thumb)) {
	   ...
	   header("location:edit_new_par_bridalproduct.php?act=show&prod_id=".$rec_get["prod_id"]."&mode=e&msg=1");
