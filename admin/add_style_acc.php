<?php
	...
	if(@$action=='add')
	{
		...
		{
			  $cid=0;
			  $cid = admin_add_style($name, $cat_image,$priority,$heading_id,$title,$description,$keyword,$alttags,$url_structure);
			if($cid != -1){
				$err="style has been added.";
			}else {
				$err = "style already exists"; 
			$name='';
			}
		}
		else
...
function submit_form()
{
    ...
    document.style.action="add_style_acc.php?action=add";
...
<tr><td height="333" class="tab" align="center" valign="middle">
	...
	<!--bof form=================================================================================-->
	<form name="style" action="add_style_acc.php?action=add" method="post" enctype="MULTIPART/FORM-data" onsubmit="javascript: return check_file();">
                    <table width=90% border=1 bordercolor=cccccc cellspacing=0 cellpadding=0><tr><td>

                    <table width=100% align=center cellspacing=2 cellpadding=2>
                    <tr bgcolor=cccccc><td align=center colspan=2><h1>ADD Style for <span style="color:red;">Jewelries And Accessories</span></h1></td></tr>
                    <tr><td align=center colspan=2 class="error"><? echo @$err; ?></td></tr>

                    <tr>
						<td width="45%" class="text" align="right">Style Name : </td>
