...
include 'top.php'; 
	...
	$sql_ = "SELECT * FROM `tblproduct_details` WHERE `prod_id`='".$_POST['prod_name']."'";
	...
	if(@$prod_name>0)
	{
		if(@$part_name!='')
		{
			if(@$prod_price!='')
			{
				...
				echo "<script>location.href='add_det_product_chandeliers.php?act=add&acts=1'</script>";     //}
			}
...
<tr>
	...
	<form name="prod_frm" method="post" action="add_det_product_chandeliers.php?act=add&acts=<?php echo $_GET['acts'];?>">
...
<tr><td align="left">
                    ...
                    <tr><td align=center colspan=2 class="error"><?php //if($_GET['acts']!=1){ echo @$err; }?></td></tr>
					  ...
					  <tr>
						  ...
						  <td width="470" align="left"><?php get_prod_add_chand();?><script>document.prod_frm.prod_name.value="<?php  echo $prod_name;?>"</script></td>
					  </tr>
					  <!--<tr>
					  	<td class="text" align="right">Select STYLE NUMBER: </td>
					    <td align="left"><?php get_prod_no();?><script>document.prod_frm.prod_no.value="<?=$prod_no;?>"</script></td>
				      </tr>-->
						<tr>
					  ...
					  <tr>
						...
						<tr>
							<td colspan=2 align=center>
								<input type="submit" name="cmd_cat_submit" class=button value=" Update ">&nbsp;&nbsp;<!--<input type="submit" name="cmd_cat_next" class=button value="Next Step">-->						
							</td>
						</tr>
					</table>
</td></tr>
