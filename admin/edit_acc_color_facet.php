<?php
	...
	if (@$action == 'delete')
	{
		$delete = "delete from tblcolors where color_id='$eid' AND heading_id = '19'";
		mysql_query($delete);
	}
	...
	{
		$sql_ = "select * from tblcolors where color_id='".$_GET['pid']."' AND heading_id = '19'";
	...
	$select = "select * from tblcolors WHERE heading_id = '19' order by color_name";
...
<tr><td height="333" class="tab" align="center" valign="middle">
	...
	<!--bof form=================================================================================-->
	<form name="faq" action="edit_acc_color_facet.php" method="post">
	<table width=70% border=1 bordercolor=cccccc cellspacing=0 cellpadding=0>
	<tr><td>
	
		<table width=100% align=center cellspacing=2 cellpadding=2 >
			<tr bgcolor=cccccc>
				<td align="center" colspan="2"><h1>Edit/Delete Color Facet For <span style="color:red;">Jelweries And Accessories</span></h1></td>
			</tr>
			<tr bgcolor=cccccc>
				<td align="right"></td>
				<td>
			...
			{
				$sql_ = "select * from `tblcolors` where `color_id`='".$row['color_id']."' AND heading_id = '19'";
				$res_ = mysql_query($sql_);
				...
				<tr align=center>
					...
					<td width="59%" align="left">
						<span class="text">[</span><a href="#" onclick="javascript:window.open('color_edit_acc_facet_popup.php?eid=<?php echo $row[color_id];?>','','height=700 width=520 scrollbars')" class="pagelinks">edit</a><span class="text">]</span>
						<span class="text">[</span><a href="edit_acc_color_facet.php?eid=<?php echo $row[color_id];?>&action=delete" onclick="return confirm_delete()" class="pagelinks">delete</a><span class="text">]</span>
