		  ...
		  <!--DWLayoutTable-->
			...
			<tr><td height="20"></td></tr> <!--added as spcer-->
				...
				*/
				...
				$select1 = "SELECT * FROM tblsubcat WHERE ".$where." AND view_status = 'Y' ORDER BY subcat_name";
	...
	{ ?>
		...
		<form name="form_edit_csv" action="edit_csv.php?cat_id=<?php echo $_GET['cat_id']; ?>&des_id=<?php echo $_GET['des_id']; ?>&subcat_id=<?php echo $_GET['subcat_id']; ?>&mode=update" method="POST">
			...
			*/
			...
			$des_result1 = mysql_query($des_select1) or dei ('Else / Select Designer error: '.mysql_error());
			...
			$subcat_result3 = mysql_query($subcat_select3) or dei ('Else / Select Subcat error: '.mysql_error());
			...
			if (file_exists($path_to_file))
			{
				...
				print('<tr bgcolor=cccccc><td colspan="20" align="center" style="vertical-align:middle;"><h1>CSV File Edit</h1></td></tr>');
				...
				for ($i = 0; $i < sizeof($filecontents); $i++) // ----> sizeof() is an alias of count()
				{
					...
					else
					{
						...
						print('
						<tr>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_0" value="'.$prod_name.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_1" value="'.$prod_no.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_2" value="'.$cat.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_3" value="'.$subcat.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_4" value="'.$designer.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_5" value="'.$prod_date.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_6" value="'.$catalog_price.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_7" value="'.$retail_price.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_8" value="'.$wholesale_price.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_9" value="'.$prod_desc.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_10" value="'.$primary_img_color.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_11" value="'.$colors.'" style="width:65px;"/></td>
							<td class="text"><input type="text" class="csvinputbox" name="index_'.$i.'_12" value="'.$style.'" style="width:65px;"/></td>
