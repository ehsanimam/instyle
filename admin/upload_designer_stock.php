...
if($_GET['msg'] == 1){
 ...
 if(empty($_POST['cmd_cat_submit'])==false){
	...
	echo "<script>window.location.href='designer_stock_process.php?file=$strFile1'</script>";
...
<tr><td align="left">
                    <table width=100% align=center cellspacing=2 cellpadding=2>
                      <!--DWLayoutTable-->
                    <tr bgcolor=cccccc><td align=center colspan=2><h1>EDIT DESIGNER STOCK</h1></td></tr>
