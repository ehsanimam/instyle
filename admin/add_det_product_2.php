	...
	if(@$prod_name>0)
	{
		if(@$part_name!='')
		{
			if(@$prod_price!='')
			{
				...
				echo "<script>location.href='add_det_product_2.php?act=add&acts=1'</script>";     //}
			}
...
<tr>
	...
	<form name="prod_frm" method="post" action="add_det_product_2.php?act=add&acts=<?php echo $_GET['acts'];?>">
...
<tr><td align="left">
                    ...
                    <tr><td align=center colspan=2 class="error"><?php //if($_GET['acts']!=1){ echo @$err; }?></td></tr>
					  ...
					  <tr>
						  ...
						  <td width="470" align="left"><?php get_prod_add();?><script>document.prod_frm.prod_name.value="<?php  echo $prod_name;?>"</script></td>
					  </tr>
					  <!--<tr>
