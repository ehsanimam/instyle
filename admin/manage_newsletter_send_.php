<?php
	...
	else
	{
		...
		require_once("httpdocs/phpscript/phpmailer/class.phpmailer.php"); // add this pages where email sending is used
		//include("../common.php");
		//require_once("../phpscript/phpmailer/class.phpmailer.php"); // add this pages where email sending is used
	}
	...
	function _send_newsletter($r)
	{
		if ($r['emails'] == 'All' OR $r['emails'] == 'Wholesale' OR $r['emails'] == 'Consumer')
		{
			...
			{
				$q_emails = "SELECT email FROM tbluser_data WHERE receive_productupd = '1'";
			}
		...
		*/
		...
		while ($email = current($emails))
		{
			...
			else
			{
				...
				include("httpdocs/phpscript/phpmailer/phpmailer_config.php");
				//include("../phpscript/phpmailer/phpmailer_config.php");
