...
function submit_form()
{
    ...
    document.style.action="add_color_facet.php?action=add";
...
<tr><td height="333" class="tab" align="center" valign="middle">
	...
	<!--bof form=================================================================================-->
	<form name="style" action="add_color_facet.php?action=add" method="post" enctype="MULTIPART/FORM-data" onsubmit="javascript: return check_file();">
	<table width=90% border=1 bordercolor=cccccc cellspacing=0 cellpadding=0>
	<tr><td>

		<table width=100% align=center cellspacing=2 cellpadding=2>
			<tr bgcolor=cccccc><td align=center colspan=2><h1>ADD Color For <span style="color:red;">Womens Apparel</span></h1></td></tr>
