<?php
	...
	if(@$action=='edit')
	{
		if($name!='')
		{
			...
			*/
			...
			print "<script>opener.location.href='edit_style.php';window.close();</script>";
		}
		else
		{
	...
	$select="select * from tblstyle where style_id='$eid' AND heading_id = '1'";
...
<!--bof form=================================================================================-->
<form name="style" action="style_edit_popup.php?eid=<?=$eid;?>&action=edit" method="post" enctype="MULTIPART/FORM-data">
<table width=100% border=1 bordercolor=cccccc cellspacing=0 cellpadding=0><tr><td>
<input type="hidden" name=eid value="<?=$eid;?>">
	<table width=100% align=center cellspacing=2 cellpadding=2>
          <!--DWLayoutTable-->
          <tr bgcolor=cccccc> 
            <td align=center colspan=2><h1>Edit Style Facet - <span style="color:red;">Womens Apparel</span></h1></td>
          </tr>
          <tr>
