...
function admin_edit_new_product($prod_id, $prod_name,$prod_no, $cat, $subcat,$subsubcat,$add_date, $catalogue_price, $less_discount, $prod_desc, $designer, $primary_img, $primary_img_id,$color,$colorname)
{
...
{
   $chkcat = "select * from tblstyle where style_name = '$cat'";
...
function admin_add_category($cat, $strFile1,$priority,$heading_id,$title,$description,$keyword,$alttags,$url_structure)
{
   ...
   if(mysql_num_rows($hcat) <= 0)
   {
	   ...
	   $sql="insert into tblcat (cat_name,cat_img,pdf_p,pdf_c,priority,heading_id,ordering,title,description,keyword,alttags,url_structure) values ('$cat','$strFile1','$strPDF_P','$strPDF_C','$priority','$heading_id','$seqes','".addslashes($title)."','".addslashes($description)."','".addslashes($keyword)."','".addslashes($alttags)."','".addslashes($url_structure)."')";
...
function admin_ins_subcat($catid, $subname,$title,$description,$keyword,$alttags,$url_structure)
{
	...
	if(mysql_num_rows($hsubcat) <= 0 )
	{
		...
		$insert_query="insert into tblsubcat(subcat_name,cat_id,icon_img,pdf_c,ordering,title,description,keyword,alttags,url_structure)values('$subname','$catid','$strFileName1','$strPDF_C','$seqes','".addslashes($title)."','".addslashes($description)."','".addslashes($keyword)."','".addslashes($alttags)."','".addslashes($url_structure)."')";
		echo $insert_query;
...
function admin_ins_subsubcat($catid,$subcatid,$subname,$title,$description,$keyword,$alttags,$url_structure)
{
	...
	if(mysql_num_rows($hsubcat) <= 0 )
	{
		...
		$insert_query="insert into tblsubsubcat(name,cat_id,subcat_id,icon_img,ordering,title,description,keyword,alttags,url_structure)values('$subname','$catid','$subcatid','$strFileName1','$seqes','".addslashes($title)."','".addslashes($description)."','".addslashes($keyword)."','".addslashes($alttags)."','".addslashes($url_structure)."')";
		mysql_query($insert_query);
		$lat=mysql_insert_id();
