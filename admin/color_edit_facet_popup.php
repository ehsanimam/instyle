<?php
	...
	if (@$action == 'edit')
	{
		if ($name != '')
		{
			...
			print "<script>opener.location.href='edit_color_facet.php';window.close();</script>";
		}
		else
		{
	...
	$select="select * from tblcolors where color_id='$eid' AND heading_id = '1'";
...
<!--bof form=================================================================================-->
<form name="style" action="color_edit_facet_popup.php?eid=<?=$eid;?>&action=edit" method="post" enctype="MULTIPART/FORM-data">
...
<tr><td>
	...
	<table width=100% align=center cellspacing=2 cellpadding=2>
		<!--DWLayoutTable-->
		<tr bgcolor=cccccc> 
            <td align=center colspan=2><h1>Edit Color Facet - <span style="color:red;">Womens Apparel</span></h1></td>
		</tr>
		<tr>
