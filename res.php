...
*/
 ...
 ! isset($_GET['img']) || $img = $_GET['img'];
 ! isset($_GET['percent']) || $percent = $_GET['percent'];
 ! isset($_GET['constrain']) || $constrain = $_GET['constrain'];

 ! isset($_GET['w']) || $w = $_GET['w'];
 ! isset($_GET['h']) || $h = $_GET['h'];
