            ...
            <tr>	
              <td width="100%" class="top" style="background:#F0F0F0;"><br /><br />
                  <table width="80%" cellpadding="0" cellspacing="0" align="center">
                    <tr>
					<tr>
					  <td class="table_title" style="background: #000000; color: #FFFFFF; font-size:24px; padding:5px 5px 5px 10px;"> SIGN IN</td>
					</tr>
                      <td valign="middle">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="5" style="background:#ffffff;margin-top:12px;border: 1px solid #DDDDDD;">
						  ...
						  <tr>
							<td colspan="3" style="padding-left:10px;"><span id="signin-note"><strong>If you have already registered with instylenewyork.com, then sign in here.</strong></span> <br>
							<span id="newsletter-note">Please note: if you have only subscribed to the weekly newsletter, you are not a registered user and need to register below. </span><?php echo $this->session->flashdata('flashMsg'); ?></td>
						  </tr>
						  <tr>
						  ...
						  <tr>
						    <td style="padding-left:10px;">Remember my password</td>
						    <td><input type="checkbox" name="setcookie" value="1"  ></td>
					   ...
					   <table width="100%" border="0" cellspacing="2" cellpadding="5" style="background:#ffffff;margin-top:12px;border: 1px solid #DDDDDD;">
						  <tr>
							<td colspan="2" style="font-size:16px;font-weight:bold; padding-left:10px;"><strong>NOT REGISTERED? THAT'S OK</strong></td>
						  </tr>
						  <tr>
						    <td style="padding-left:10px;">If you are new to Instyle, please click 'Register now'. </td>
						    <td width="18%">
							<a href="register.html"><img src="images/registernow.gif" border="0" /></a>
							</td>
					      </tr>
						  <tr>
					   ...
					   <table width="100%" border="0" cellspacing="2" cellpadding="5" style="background:#ffffff;margin-top:12px;border: 1px solid #DDDDDD;">
						  ...
						  <tr>
						    ...
						    <td width="18%">
							<a href="reset-password.html" class="popupwindow"><img src="images/changepassword.gif" border="0" /></a></td>
					      </tr>
						  <tr>
						    <td colspan="2" style="font-size:1px;">&nbsp;</td>
					      </tr>
