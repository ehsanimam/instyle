		...
		*/
		...
		<table border="0" cellspacing="0" cellpadding="5" width="100%">
			...
			foreach ($this->cart->contents() as $items):
				// ----> These hidden fields are currently not used in the next process
				...
				?>			
				<tr>
					<td style="border-bottom:1px solid #999;width: 80px;"><a href="<?php echo $items['options']['current_url']; ?>"><img src="<?php echo base_url(); ?>res.php?w=60&h=90&constrain2=1&img=<?php echo $items['options']['prod_image']; ?>" width="60" height="90" border="0"></a></td>
