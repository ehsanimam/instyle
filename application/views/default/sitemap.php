			...
			<div style="border-bottom: 1px solid #999999;height: 60px;padding: 14px 0 15px 1px;width: 760px;">
				...
				<div class="normal_txt2">
					...
					{ ?>
						...
						<a href="<?php echo site_url('return-policy'); ?>" class="normal_txt" style="font-weight:normal; text-decoration:none;">Return Policy</a><span class="lseparator">&nbsp; &nbsp; | &nbsp; &nbsp;</span>
						...
						<a href="<?php echo site_url('privacy-notice'); ?>" class="normal_txt" style="font-weight:normal; text-decoration:none;">Privacy Notice</a><span class="lseparator">&nbsp; &nbsp; | &nbsp; &nbsp;</span>
						<a href="<?php echo site_url('order-status'); ?>" class="normal_txt" style="font-weight:normal; text-decoration:none;">Order Status</a><span class="lseparator">&nbsp; &nbsp; | &nbsp; &nbsp;</span>
