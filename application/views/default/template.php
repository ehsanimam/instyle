				...
				<tr>
					...
					<td align="right" valign="top">
						<table border=0 cellpadding=0 cellspacing=0>
							...
							<tr><td align="right" style="font-family:Arial; font-size: 10px; font-weight:normal;">EMAIL: <?php echo safe_mailto('info@instylenewyork.com', 'INFO@INSTYLENEWYORK.COM'); ?></td></tr>
