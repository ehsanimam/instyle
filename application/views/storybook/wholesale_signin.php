				...
				<td valign="middle">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="5" style="background:#ffffff;margin-top:12px;border: 1px solid #DDDDDD;">
						...
						<tr>
						    ...
						    <td width="18%">
								<a href="<?php echo site_url('wholesale/register'); ?>"><img src="../images/registernow.gif" border="0" /></a>
							</td>
						</tr>
						<tr>
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="5" style="background:#ffffff;margin-top:12px;border: 1px solid #DDDDDD;">
						...
						<tr>
						    ...
						    <td width="18%">
								<a href="<?php echo site_url('wholesale/reset_password'); ?>" class="popupwindow"><img src="../images/changepassword.gif" border="0" /></a>
							</td>
						</tr>
						<tr>
						    <td colspan="2" style="font-size:1px;">&nbsp;</td>
