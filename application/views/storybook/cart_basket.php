		...
		<td>
						...
						{ ?>
								<td align="right">
									...
									<select id="continue">
										...
										<option value="<?php echo str_replace('https','http', site_url('new-arrival')); ?>">New Arrival</option>
										<option value="<?php echo str_replace('https','http', site_url('apparel')); ?>">Womens Apparel</option>
										<option value="<?php echo str_replace('https','http', site_url('jewelry')); ?>">Jewelry &amp; Accessories</option>
										<option value="<?php echo str_replace('https','http', site_url('clearance')); ?>">Clearance</option>
									</select>
									<script>
										$(function(){
							...
							<tr>
								<td colspan="2" align="center" style="padding-top:20px;color:gray;font-size:12px;">
									Minimun First Order 15 Units - You will be contacted by saless to complete this order.
								</td>
							<?php
						} ?>
					</tr>
			...
			*/
			...
			foreach ($this->cart->contents() as $items):
				...
				<tr>
					<td style="border-bottom:1px solid #efefef;"><img src="<?php echo base_url().$items['options']['prod_image']; ?>" alt = "Front" style="border:1px solid #333;" border="0"/></td>
			...
			*/
			if ($this->session->userdata('user_cat') == 'wholesale')
			{
				...
				$hidden_input = array(
					...
					'payment_storename'		=> $cur_user_info->store_name,
