		...
		*/
		echo '
			<div style="width:170px; margin:2px 5px 10px 15px; float:left; text-align:left;">
				'.anchor($url_link.'/'.$item['ssc_url_structure'], img(array('src' => $this->config->item('PROD_IMG_URL').'images/subsubcategory_icon/'.$item['ssc_icon_img'], 'border' => '0', 'alt' => $alts, 'title' => $alts))).'
				<br /><b><u>'.$item['subsubcat_name'].'</u></b>
				<br />'.$item['ssc_description'].'
			</div>
		';
