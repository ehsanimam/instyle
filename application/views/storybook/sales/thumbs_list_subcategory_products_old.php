		...
		<div style="width:141px;float:left;margin:2px 0px 15px 15px;">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr><td colspan="2" style="height:210px;">
					...
					$local_path = 'D:\www\joetaveras\product_repo\\';
					...
					$seg = 'product_assets/'.$thumb->cat_folder.'/'.$thumb->folder.'/'.$thumb->sc_folder.'/product_linesheet/';
...
<!-- Thumbnail Placeholder ===============================================-->
					<div id="<?php echo $thumb->prod_no.'_'.$thumb->color_code; ?>" class="fadehover" style="width:140px;height:210px;">
						...
						/*
						| ---------------------------
						| New display of thumbs using re-sampled image at product_<view>/thumbs fodler
						...
						*/
						...
						if (@GetImageSize(PROD_IMG_URL.$img_thumb))
						//if (file_exists(PROD_IMG_URL.$seg.$thumb->prod_no.'_'.$thumb->color_code.'.jpg'))
						{
