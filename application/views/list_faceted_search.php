		...
		<div style="width:141px;float:left;margin:2px 0px 15px 15px;">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr><td colspan="2" style="height:210px;">
					...
					// assign the images
					$img_url		 = base_url().'product_assets/'.$thumb->cat_folder.'/'.$thumb->d_folder.'/'.$thumb->subcat_folder.'/';
					...
					*/
					...
					<div class="fadehover">
						...
						if ($seg1 == 'new-arrival-facets' OR $seg1 =='new-arrival-designer-facets')
						{
							$uri_seg1 = 'new-arrival/';
						}
						else if ($seg1 == 'clearance-facets' OR $seg1 == 'clearance-designer-facets')
						{
							$uri_seg1 = 'clearance/';
						}
						else $uri_seg1	= str_replace('facets-','',$this->uri->segment(1)).'/';
