...
<?php
	/*
	if (isset(ENVIRONMENT) && (ENVIRONMENT == 'development' OR ENVIRONMENT == 'testing'))
		$pre = '_ ';
	else $pre = '';
					...
					<td align="right" valign="top">
						<table border=0 cellpadding=0 cellspacing=0>
							<tr><td align=right style="vertical-align:top;">
								...
								{ ?>
									<?php $link_class = uri_string() == 'page/wholesale_ordering' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/wholesale_ordering')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">ORDERING</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/wholesale_return_policy' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/wholesale_return_policy')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">RETURNS</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/wholesale_shipping' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/wholesale_shipping')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">SHIPPING</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/wholesale_privacy_notice' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/wholesale_privacy_notice')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">PRIVACY</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/wholesale_order_status' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/wholesale_order_status')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">ORDER STATUS</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/wholesale_faq' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/wholesale_faq')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">FAQ</a><span class="lseparator">|</span>
									<?php
								}
								else
								{ ?>
									<?php $link_class = uri_string() == 'page/ordering' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/ordering')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">ORDERING</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/return_policy' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/return_policy')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">RETURNS</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/shipping' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/shipping')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">SHIPPING</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/privacy_notice' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/privacy_notice')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">PRIVACY</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/order_status' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/order_status')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">ORDER STATUS</a><span class="lseparator">|</span>
									
									<?php $link_class = uri_string() == 'page/faq' ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('page/faq')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">FAQ</a><span class="lseparator">|</span>
									<?php
								}
								?>
								
								<?php $link_class = uri_string() == 'page/press' ? 'color:#AA0000;' : ''; ?>
								<a href="<?php echo str_replace('https','http',site_url('page/press')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">PRESS</a><span class="lseparator">|</span>
								<?php $link_class = uri_string() == 'page/sitemap' ? 'color:#AA0000;' : ''; ?>
								<a href="<?php echo str_replace('https','http',site_url('page/sitemap')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">SITEMAP</a><span class="lseparator">|</span>
								...
								<?php $link_class = uri_string() == 'page/contact' ? 'color:#AA0000;' : ''; ?>
								<a href="<?php echo str_replace('https','http',site_url('page/contact')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">CONTACT</a>
								<br /><br />
							</td></tr>
