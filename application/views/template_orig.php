						...
						<table border=0 cellpadding=0 cellspacing=0>
							<tr><td align=right style="vertical-align:top;">
								...
								{ ?>
									...
									<?php $link_class = ($this->uri->segment(2) == 'return-policy.html') ? 'color:#AA0000;' : ''; ?>
									...
									<?php $link_class = ($this->uri->segment(2) == 'privacy-notice.html') ? 'color:#AA0000;' : ''; ?>
									...
									<?php $link_class = ($this->uri->segment(2) == 'order-status.html') ? 'color:#AA0000;' : ''; ?>
								...
								{ ?>
									...
									<?php $link_class = ($this->uri->segment(2) == 'return-policy.html') ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('p2/return-policy.html')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">RETURNS</a><span class="lseparator">|</span>
									...
									<?php $link_class = ($this->uri->segment(2) == 'privacy-notice.html') ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('p4/privacy-notice.html')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">PRIVACY</a><span class="lseparator">|</span>
									
									<?php $link_class = ($this->uri->segment(2) == 'order-status.html') ? 'color:#AA0000;' : ''; ?>
									<a href="<?php echo str_replace('https','http',site_url('p5/order-status.html')); ?>" style="font-family:Arial; font-size: 10px; font-weight:normal; text-decoration:none;<?php echo $link_class; ?>">ORDER STATUS</a><span class="lseparator">|</span>
