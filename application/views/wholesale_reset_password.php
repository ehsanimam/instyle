...
<tr><td>
	...
	<br /><br />
		...
		<table width="80%" cellpadding="0" cellspacing="0" align="center"=>
			<tr>
				<td class="table_title" style="background: #000000; color: #FFFFFF; font-size:24px; padding:5px 5px 5px 10px;"> RECOVER PASSWORD </td>
			</tr>
			<tr>
				<td valign="middle">
					...
					<!--bof form===========================================================================-->
					<?php echo form_open('wholesale/reset_password.html'); ?>
					<table width="100%" border="0" cellspacing="2" cellpadding="5" style="background:#ffffff;margin-top:12px;border: 1px solid #DDDDDD;">
						...
						<tr>
							...
							<td width="28%"><input type="submit" name="sub" value="Recover Password" class="bottonlook2" /></td>
						</tr>
						<tr>
